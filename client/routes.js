  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route exact path="/home/rosewines" component={RoseWines} />
        <Route exact path="/home/redwines" component={RedWines} />
        <Route exact path="/home/whitewines" component={WhiteWines} />
